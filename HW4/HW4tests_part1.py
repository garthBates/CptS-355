...
class HW4Sampletests_part1(unittest.TestCase):
    ...
    def test_putinterval1(self):
        ...
        opPush('(CptS355-and-CptS322)')
        dup()  #duplicating the string reference
        opPush(4)
        opPush('(451)')
    ...
    def test_astore(self):
        ...
        opPush(True)
        opPush('(end)')
        opPush([0,0,0,0])  # the array doesn't necessarily neeed to have 0 values. 
        astore()
    ...
    #-----------------------------------------------------
    #Additional tests for get, getinterval, putinterval, search, def, begin, end, evaluateArray

    def test_get2(self):
        opPush('(This is a test)')
        opPush(6)
        get()
        self.assertEqual(opPop(), 115)
        self.assertTrue(len(opstack)==0)
    ...
    def test_putinterval4(self):
        opPush('(This is a test)')
        dup()
        opPush(6)
        opPush('(test)')
        putinterval()
        self.assertEqual(opPop(), '(This itesttest)')
        self.assertTrue(len(opstack)==0)
    ...
    def test_search3(self):
        ...
        opPush('(14)')
        search()
        self.assertTrue(opPop() == False and opPop() == '(This is a test)')
    ...
    def test_evaluateArray2(self):
        define('/x', 3)
        self.assertEqual(evaluateArray([1, 2, 'x', 'add']), [1, 5])
